...
// the LP64 build keeps the Windows LLP64 sizes. See tools/oracle/README.md.
#include <cstdint>
...
typedef uint32_t WORD32;          // ORACLE PATCH: was "unsigned long" (32-bit on Win32/Win64 LLP64)
typedef uint64_t WORD64;          // ORACLE PATCH: was "unsigned __int64"

typedef short SIGNED16;
typedef int32_t SIGNED32;          // ORACLE PATCH: was "long" (32-bit on Windows)
typedef int64_t SIGNED64;          // ORACLE PATCH: was "__int64"
